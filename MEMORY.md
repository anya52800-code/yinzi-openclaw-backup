...
## 最近更新
- 2026-05-14: **暴雪术士视觉方向确认** — 全票通过Option 1，弹性层正式获批，6月17日上线。品牌升级推迟至11-12月，详见 `memory/2026-05-14.md`
- 2026-05-14: **GitHub全量备份+家中恢复** — 备份脚本`github-auto-backup.ps1`+恢复脚本`restore-from-github.ps1`，家中电脑一键恢复所有内容（记忆/技能/配置），详见 `memory/2026-05-14.md`
- 2026-05-13: **朴茶别院品牌保护** — 拒绝朋友招牌授权请求，守住品牌边界；完成商标备选查询（朴茶山房/璞茶别院等），产出寄售协议模板+注册流程指南，详见 `memory/2026-05-13.md`
